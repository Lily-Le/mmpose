...
model = dict(
    type='TopDown',
    # pretrained='/home/zlc/cll/code/peclr/data/models_res18/hybrid2-ori-data4/7992e56f43e34e75b3771644670c5898/port_model/epoch=44_state.pth',
    pretrained='/workspace/cll/Exp_results/peclr/pretrained_res18_state.pth',
